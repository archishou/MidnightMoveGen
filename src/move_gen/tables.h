...
private:
	...
	static constexpr array<i32, NSQUARES> RookShifts = {
	...
	static constexpr array<i32, NSQUARES>  BishopShifts = {
	...
	static constexpr array<Bitboard, NSQUARES> KING_ATTACKS = {
	...
	static constexpr array<Bitboard, NSQUARES> KNIGHT_ATTACKS = {
	...
	static constexpr array<Bitboard, NSQUARES> WHITE_PAWN_ATTACKS = {
	...
	static constexpr array<Bitboard, NSQUARES> BLACK_PAWN_ATTACKS = {
			0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
	...
	static constexpr array<Bitboard, NSQUARES> BISHOP_MAGICS = {
	...
	static constexpr array<Bitboard, NSQUARES> ROOK_MAGICS = {
	...
	constexpr Bitboard board_edge(Direction D) {
	...
	constexpr Bitboard generate_sliding_attacks(Square sq, Direction direction, Bitboard occupancy) {
		Bitboard attacks{};
	...
	constexpr AttackData generate_orthogonal_slider_data() {
		AttackData dst{};
		...
		for (Square sq = a1; sq < NSQUARES; sq++) {
			...
			dst.table_size += 1 << (NSQUARES - RookShifts[sq]);
		}

		return dst;
	}
	TEST_CASE_CLASS("generate-sliding-attacks") {
		AttackTables tables{};
		CHECK_EQ(tables.generate_sliding_attacks(a5, NORTH, 0), 0x101010000000000);
		CHECK_EQ(tables.generate_sliding_attacks(a5, SOUTH, 0), 0x1010101);
		CHECK_EQ(tables.generate_sliding_attacks(e4, NORTH, 0), 0x1010101000000000);
		CHECK_EQ(tables.generate_sliding_attacks(e4, SOUTH, 0), 0x101010);
		CHECK_EQ(tables.generate_sliding_attacks(e4, EAST, 0), 0xe0000000);
		CHECK_EQ(tables.generate_sliding_attacks(e4, WEST, 0), 0xf000000);
		CHECK_EQ(tables.generate_sliding_attacks(e4, NORTH_EAST, 0), 0x80402000000000);
		CHECK_EQ(tables.generate_sliding_attacks(e4, NORTH_WEST, 0), 0x102040800000000);
		CHECK_EQ(tables.generate_sliding_attacks(e4, SOUTH_EAST, 0), 0x204080);
		CHECK_EQ(tables.generate_sliding_attacks(e4, SOUTH_WEST, 0), 0x80402);
	}
};
